...
class TechnicalData:
    rsi: float | None
    macd: float | None          # MACD line value (last bar)
    macd_signal: float | None   # Signal line value (last bar)
    macd_histogram: float | None
    price_vs_sma50: float | None   # % above/below 50-day SMA
    price_vs_sma200: float | None  # % above/below 200-day SMA
...
def compute_macd(
    ...
    """Returns (macd_line, signal_line, histogram) for the last bar."""
